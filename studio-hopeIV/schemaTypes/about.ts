...
export const about = defineType({
  ...
  fields: [
    defineField({
      ...
      title: 'Page Title',
      type: 'string',
      description: 'The main title displayed on the About page (e.g., "About HopeIV Spaza Studio").',
    ...
    defineField({
      ...
      defineField({
        ...
        type: 'text',
        description: 'A brief background or motivation behind starting HopeIV (optional).',
      }),
    defineField({
        name: 'callToAction',
